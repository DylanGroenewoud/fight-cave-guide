...
public class SpeedrunWaveData {
    ...
    static {
        ...
        waveTileMap.put(38, new FightCaveWave.Builder(
                ...
                .nextWaveMessages(List.of("Spam sweets and blowpipe spec the bat"))
                .build());
        ...
        waveTileMap.put(41, new FightCaveWave.Builder(
                ...
                .requiresAutoRetaliate()
                .currentWaveMessages(List.of("P-neck wave"))
                .build());
        ...
        waveTileMap.put(42, new FightCaveWave.Builder(
                ...
                .currentWaveMessages(List.of("Trap the 45 behind the 360 before running into the corner"))
                .build());
        ...
        waveTileMap.put(43, new FightCaveWave.Builder(
                ...
                .nextWaveMessages(List.of("Blowpipe spec the 45 and run far EAST"))
                .requiresLogout()
                .build());
        ...
        waveTileMap.put(44, new FightCaveWave.Builder(
                ...
                .currentWaveMessages(List.of("Blowpipe spec the 45 and run EAST"))
                .nextWaveMessages(List.of("~30+hp, start in the NE corner"))
                .build());
        ...
        waveTileMap.put(49, new FightCaveWave.Builder(
                ...
                .currentWaveMessages(List.of("Blowpipe spec the 45, block 180 with 22s"))
                .nextWaveMessages(List.of(
        ...
        waveTileMap.put(51, new FightCaveWave.Builder(
                ...
                .nextWaveMessages(List.of("Kill the first 45, use second to block 180"))
                .build());
        ...
        waveTileMap.put(52, new FightCaveWave.Builder(
                ...
                .nextWaveMessages(List.of("WAIT AT TILE 2 (get the 180 stuck behind the 360)"))
                .requiresLogout()
                .build());
        ...
        waveTileMap.put(54, new FightCaveWave.Builder(
                ...
                .currentWaveMessages(List.of("Run into the NE corner"))
                .build());
        ...
        waveTileMap.put(55, new FightCaveWave.Builder(
                ...
                .currentWaveMessages(List.of("Run around the 360 to tile 5"))
                .nextWaveMessages(List.of("P-neck wave"))
                .build());
        ...
        waveTileMap.put(57, new FightCaveWave.Builder(
                ...
                .nextWaveMessages(List.of("~15hp+ before starting the next wave"))
                .build());
        ...
        waveTileMap.put(58, new FightCaveWave.Builder(
                ...
                .requiresLogout()
                .currentWaveMessages(List.of("Blowpipe spec the 90"))
                .nextWaveMessages(List.of("~10hp"))
                .build());
